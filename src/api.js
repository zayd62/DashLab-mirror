...
export const FUNC_CREATESOCIALMODEL = `${URL_DOMAIN}/api/createModel/`;
...
export const FUNC_SAMPLEGET = async function getCities() {
  ...
  try {
    ...
    await axios
      .get("https://jsonplaceholder.typicode.com/todos/2000")
      .then(res => {
  ...
  console.log(
    "this SHOULD print after the api response has been received has finished"
  );
